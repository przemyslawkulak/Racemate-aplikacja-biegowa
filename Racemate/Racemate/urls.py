...
from group.views import RunningGroupView, MemberView, CreateGroupView, ShowGroupsView, JoinGroupView, JoinConfirmView, \
    AdminConfirmView
from main.views import (LogoutView, LoginView, LandingView, customhandler404, customhandler500, RegisterView)
from messanger.views import ForumView, ForumChoiceView, SendMessageView, SendMessageGroupView, MessangerView
from training.views import LandingGeneratorView, AddTrainingView, AddTreningView, TreningPlanWhiteView, \
    TreningPlan18weeksView, LoadTreningView, PlanChoiceView, DeleteTrainingView, PastTrainingDelete
