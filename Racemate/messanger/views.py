...
class ForumView(LoginRequiredMixin, View):
    def get(self, request, id):
        ...
        return render(request, 'main/forum.html', {'messages': messages, 'group': group, "user": user})
...
class MessangerView(LoginRequiredMixin, View):
    def get(self, request, id):
        ...
        return render(request, 'main/messanger.html', {"msg": msg, 'user': user, 'interlocutor': interlocutor})
